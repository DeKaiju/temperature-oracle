 ...
 * controller's owner.
 */
contract WriteAccessController is Owned {
     ...
     */
    function hasAccess(address _user, bytes memory) public view virtual returns (bool) {
    ...
    function removeAccessInternal(address _user) internal {
        if (accessList[_user]) {
